...
class UsuarioTest {
    ...
    void quando_construtor_todos_campos_diferente_null() {
        Usuario usuario = new Usuario(1l, "Carlos", "calor@gmail.com", "34343434343423", "31413468012");
    ...
    void quando_alterar_senha_1234567878_senha_alterada() {
        Usuario usuario = new Usuario(1l ,"Carlos", "calor@gmail.com", "12345678", "31413468012");
    ...
    void quando_usuario_criado_com_senha_menor_que_8_retorna_exception() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Usuario usuario = new Usuario(1l ,"Carlos", "calor@gmail.com", "1234567", "31413468012");
        });
    }
    ...
    void quando_usuario_criado_com_email_vazio_retorna_exception() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Usuario usuario = new Usuario(1l ,"Carlos", "   ", "12345678", "31413468012");
        });
    }
    ...
    void quando_usuario_criado_com_nome_vazio_retorna_exception() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Usuario usuario = new Usuario(1l ,"   ", "calor@gmail.com", "12345678", "31413468012");
        });
    }
    @Test
    void quando_usuario_criado_com_senha_vazio_retorna_exception() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Usuario usuario = new Usuario(1l ,"Carlos", "calor@gmail.com", "            ", "31413468012");
        });
    }
    @Test
